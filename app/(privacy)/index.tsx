  ...
  useEffect(() => {
    if (!visible) {
      const timeout = setTimeout(() => {
        router.back();
      }, 300); // must match SlideOutDown duration
  ...
  return (
    <View className="flex-1 justify-end bg-black/40">
      {visible && (
        ...
        >
          {/* Drag Handle */}
          <View className="items-center pt-3 pb-1 bg-gradient-to-b from-[#EAF6F1] to-[#EAF6F1]/80">
            <View className="h-1.5 w-12 rounded-full bg-[#01985e]/30" />
          </View>
          ...
          <View className="relative px-6 pt-6 pb-6">
            ...
            <View className="flex-row justify-between items-start mb-4">
              <View className="flex-row items-center gap-3 mt-4">
                ...
                <Text
                    className="text-3xl text-[#0C1C16]"
          ...
          >
            ...
            <View className="mb-8 bg-[#01985e]/5 rounded-xl p-5 border border-[#01985e]/10">
              <View className="flex-row items-center gap-2 mb-3">
                ...
                <Text className="text-lg font-bold text-[#01985e]">
                  AI & Conversations
                </Text>
              </View>
...
function Section({
  ...
  return (
    <View className="mb-8">
      <View className="flex-row items-center gap-2 mb-3">
        <Text className="text-[#01985e] italic font-serif">{index}</Text>
